...
5. **Stay Signed in to all your apps** dialog opens. Select **Yes**.
...
10. Notice there are two fact tables, Sales and PO.
    ...
    i. Granularity of Sales data is by Date, Reseller, Product, and People. Date, Reseller, Product, and People connect to Sales.

    ii. Granularity of PO data is by Date, Product, and People. Date, Product, and People connect to PO.

    iii. We have Supplier data by Product. Supplier connects to Product.

    iv. We have Reseller’s location data by Geo. Geo connects to Reseller.

    v. We have Customer information by Reseller. Customer connects to Reseller.
