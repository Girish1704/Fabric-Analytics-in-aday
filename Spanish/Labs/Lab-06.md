...
2. Se abre el cuadro de diálogo **Nuevo modelo semántico**. Escriba
    **sm_FAIAD** como nombre del modelo semántico de Direct Lake.

3. Tenemos la opción de seleccionar un subconjunto de las tablas de
...
4. Haga clic en la **marca de verificación** izquierda de la barra de
    fórmulas o haga clic en el botón **Entrar**.
