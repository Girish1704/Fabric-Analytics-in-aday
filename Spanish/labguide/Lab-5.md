...
14. Esto ahora nos permite especificar la cadencia de la actualización seleccionando una opción para la propiedad **Repeat**. Para este escenario podemos elegir **Diario (1)**.
...
2. En el menú superior, seleccione **+ Nuevo elemento (1) -> Canalización (2)**.
