...
1.  ラボ 2 で作成した **FAIAD\_\<ユーザー名\>** という名前の **Fabric** ワークスペースに戻りましょう。
...
11. レポートがワークスペース **FAIAD\_\<ユーザー名\>** に保存されることを確認します。
...
1.  **左側のパネル**で、ワークスペース名 **FAIAD\_\<ユーザー名\>** を選択して、ワークスペースに移動します。
...
3.  レポートが **FAIAD\_\<ユーザー名\>** ワークスペースに保存されることを確認します**。**
...
3.  左のメニュー バーで **FAIAD\_\<ユーザー名\>** を選択して、ワークスペースのホームに移動します。
...
1.  左側のパネルで **FAIAD\_\<ユーザー名\>** ワークスペースを選択して、ワークスペースのホームに移動します。
