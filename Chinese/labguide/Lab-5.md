...
1. 让我们通过在左侧面板中选择 Fabric 工作区 **FAIAD_<inject key="Deployment ID" enableCopy="false"/>_CN**，导航回该工作区。
...
3. 确保将**工作区**设置为您的 Fabric 工作区 **FAIAD_<inject key="Deployment ID" enableCopy="false"/>_CN。**
...
1. 从左侧面板中，点击 **FAIAD_<inject key="Deployment ID" enableCopy="false"/>_CN**，以导航到工作区主页。
...
8. 确保将**工作区**设置为您的工作区 **FAIAD_<inject key="Deployment ID" enableCopy="false"/>_CN。**
...
8. 设置您的**时区**。
    ...
    > **注意：** 由于这是实验环境，您可以将时区设置为您偏好的时区。在实际应用场景中，应根据您所在的位置或数据源的位置来设置时区。
...
11. 从左侧面板中选择您的 Fabric 工作区 **FAIAD_<inject key="Deployment ID" enableCopy="false"/>_CN**，以导航到工作区。
