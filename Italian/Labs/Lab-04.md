...
5. Nella barra multifunzione selezionare **Home -> Trasforma dati**.
    Si apre la finestra Power Query. Come abbiamo visto nei lab
    precedenti, le query nel pannello di sinistra sono organizzate per
    origine dati.
...
4. **Selezionare Nuova connessione (1).** Si aprirà la finestra di
