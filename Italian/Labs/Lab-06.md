...
1. Nel menu dell'endpoint di analisi SQL selezionare **Nuovo modello
    semantico**.

    ![](../media/Lab-06/image13.png)

2. Viene visualizzata la finestra di dialogo **Nuovo modello
    semantico**. Immettere **sm_FAIAD** come nome del modello semantico
    Direct Lake.

3. Per impostazione predefinita abbiamo la possibilità di selezionare
...
9. Con la **tabella** **Sales** selezionata nel menu in alto,
    selezionare **Home -> Nuova misura**. Notare che viene visualizzata
    la barra della formula.
