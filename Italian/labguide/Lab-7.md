...
1.  Torniamo **all'area di lavoro di Fabric** creata nel Lab 2, di nome **FAIAD\_\<nome utente\>**.
...
11. Assicurarsi che il report sia salvato nell'area di lavoro **FAIAD\_\<nome utente\>.**
...
1.  Nel **pannello di sinistra** selezionare il nome dell'area di lavoro, **FAIAD\_\<nome utente\>**, per tornare a essa.
...
3.  Assicurarsi che il report sia salvato nell'area di lavoro **FAIAD\_\<nome utente\>.**
...
3.  Selezionare **FAIAD\_\<nome utente\>** nella barra dei menu di sinistra per andare alla home page dell'area di lavoro.
...
1.  Selezionare l'area di lavoro **FAIAD\_\<nome utente\>** nel pannello di sinistra per andare alla home page dell'area di lavoro.
