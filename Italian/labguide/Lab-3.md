...
2. Se non è disponibile alcuna scheda, è possibile tornare all'area di lavoro e aprire il lakehouse da lì.
...
12. Si stabilirà una connessione ad ADLS Gen2 con la struttura di directory visualizzata nel pannello di sinistra. Espandere **Delta-Parquet-Format-FY25 (1).**

13. **Selezionare** le directory seguenti **(2)** e fare clic su **Avanti (3):**
...
19. Notare che tutti i collegamenti vengono creati come tabelle. Selezionare la tabella **BuyingGroups**; è possibile vedere un'anteprima dei dati nel pannello dati.
