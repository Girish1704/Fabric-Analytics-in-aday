...
1.  Torniamo all'area di lavoro di Fabric, **FAIAD\_\<nome utente\>** selezionandola nel pannello di sinistra.
...
8.  Assicurarsi che l'**Area di lavoro** sia impostata sulla propria area di lavoro **FAIAD\_\<nomeutente\>**.
...
11. Selezionare l'area di lavoro di Fabric **FAIAD\_\<nome utente\>** nel pannello di sinistra per andare all'area di lavoro**.**
