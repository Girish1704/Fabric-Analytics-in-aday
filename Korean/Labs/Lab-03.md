...
- **파이프라인:** 이는 오케스트레이션 도구입니다. 데이터를 추출, 변환,
  수집하도록 활동을 조정할 수 있습니다. 파이프라인을 사용하여 데이터
  흐름 2세대 활동을 실행하여 추출, 변환, 수집이 수행되도록 할 수
  있습니다.
...
a)  탭이 없는 경우 작업 영역으로 돌아가서 레이크하우스 열 수 있습니다.
...
3. **새 바로 가기**를 선택합니다.
    ...
    ![](../media/Lab-03/image2.png)
4. **새 바로 가기** 대화 상자가 열립니다. **외부 원본**에서 **Azure
    Data Lake Storage Gen2**를 선택합니다.

    ![](../media/Lab-03/image3.png)
...
7. Connection(연결) 섹션에서 **Create New Connection(새 연결
    만들기)**(3)을 클릭합니다.

8. 인증 종류 드롭다운에서 **SAS(공유 액세스 서명) (4)**을 선택합니다.
...
> **참고:** Sales.Invoices_May는 선택되지 **않은** 유일한
> 디렉터리입니다.

    ![](../media/Lab-03/image5.png)

13. 이름을 편집할 수 있는 다음 대화 상자로 이동합니다.
...
> **참고:** 이름을 다시 확인하세요. 랩 도중 오타로 인해 오류가
> 발생합니다.

17. **만들기**를 선택하여 바로 가기를 만듭니다.

    ![](../media/Lab-03/image7.png)
18. 모든 바로 가기가 Tables로 생성되는 것을 확인할 수 있습니다.
...
**중요:** 아래로 스크롤하여 21단계에 나열된 8개 열을 모두 선택해야
합니다. 아래 스크린샷은 UI 제한으로 인해 처음 5개의 열만 표시합니다.
...
4. **Customers** 쿼리를 선택합니다. 선택하면 Customers에 파란색
    ...
    뒤에 단계를 추가하고 있음을 나타냅니다). 테이블 뒤에 **"+"** 기호가
...
18. Customers 쿼리는 모든 단계에 포함되어 있으므로 저장해야 합니다.
    로드를 활성화합니다. **Customers** 쿼리 상자에서 **말줄임표**를
    선택합니다.
...
incorrect.](../media/Lab-03/image39.png)
...
generated](../media/Lab-03/image44.png)
...
incorrect.](../media/Lab-03/image46.png)
...
generated](../media/Lab-03/image56.png)
...
incorrect.](../media/Lab-03/image60.png)
