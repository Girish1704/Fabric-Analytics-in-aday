...
2. 왼쪽 패널의 아래쪽에서 **Fabric 환경 선택기** 아이콘을 선택합니다.
    ...
    ![](../media/Lab-07/image2.png)

3. Fabric 환경 대화 상자가 열립니다. **Power BI**를 선택합니다. **Power
    BI 홈 페이지**로 이동합니다.

    ![](../media/Lab-07/image3.png)

4. 상단 메뉴에서 **새 보고서**를 선택합니다.

    ![](../media/Lab-07/image4.png)
...
5. **첫 번째 보고서 화면 만들기**로 이동됩니다. Excel, CSV를 사용하여
    ...
    ![](../media/Lab-07/image5.png)

6. 보고서 페이지에서 사용할 데이터 세트를 선택합니다. 다양한 옵션이
    있다는 사실을 알아 두십시오. **sm_FAIAD**를 선택합니다.

    - **sm_FAIAD:** 이것은 우리가 만든 의미 체계 모델이며 보고서를
      작성하는 데 사용하고자 합니다.

    - **lh_FAIAD:** 모든 데이터를 수집한 레이크하우스입니다.

    - **Units by Supplier:** 이것은 T-SQL을 사용하여 생성한 데이터
      세트입니다.
...
5. **카드 시각적 개체가 선택된** 상태에서 **시각화** 섹션에서 **시각적
    개체 서식 지정 아이콘을** 선택합니다.
...
18. **시각적 개체**의 크기를 조정하고 **스크린샷과 같이 왼쪽 상자**로
    옮깁니다.

    ![](../media/Lab-07/image20.png)

19. 또 다른 카드를 추가해 보겠습니다. 방금 만든 **Sales 카드**를
    선택합니다. 키보드에서 **Ctrl+C**를 선택하여 시각적 개체를
    **복사**합니다.

20. 키보드에서 **Ctrl+V**를 선택하여 시각적 개체를 **붙여넣기**합니다.
    시각적 개체가 캔버스에 붙여넣기 됐습니다.

21. **새 시각적 개체가 강조표시된** 상태에서 **시각화 창 -> 시각적 개체
    빌드 -> 필드** 섹션에서 **Sales** 측정값을 제거합니다.

22. **데이터** 섹션에서 **Sales** 테이블을 확장하고 **Units** 측정값을
    선택합니다.

23. **시각적 개체**의 크기를 조정하고 **Sales 시각적 개체 아래의
    상자에** 넣습니다.
...
2. **상단 메뉴**에서 **의미 체계 모델 열기**를 선택합니다. 새 브라우저
...
11. **꺾은선형 차트 시각적 개체를 선택한** 상태에서 Y축에서 **Year
    합계**를 제거합니다.
...
2. 리본 메뉴에서 **홈 -> OneLake 카탈로그 -> Power BI 의미 체계
    모델**을 선택합니다.
...
16. 리본 메뉴에서 **홈 -> 붙여 넣기**를 선택합니다. 시각적 개체가
...
7. 새 바로 가기 대화 상자가 열립니다. **외부 소스**에서 **Azure Data
...
24. 상단 메뉴에서 **새로 고침 아이콘을** 선택합니다. 이제 꺾은선형
    차트에 2024년 5월의 데이터가 있습니다. 또한 매출액이 증가한 것을
    확인할 수 있습니다.
    ...
    파이프라인은 새로 고침에 실패하더라도 이를 재시도하고 다양한 시간 간격에
    따라 시도하는 기능을 제공하여 이러한 문제를 해결하도록 돕습니다.
