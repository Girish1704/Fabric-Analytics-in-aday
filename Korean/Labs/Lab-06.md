...
2. 새 의미 체계 모델 대화 상자가 열립니다. **sm_FAIAD**를 Direct Lake
    의미 체계 모델 이름으로 입력합니다.

3. 기본적으로 테이블의 하위 집합을 선택할 수 있는 옵션이 있습니다. 이전
...
8. 이제 Product와 Supplier 간의 관계를 만들어 보겠습니다. **+ 새
    관계**를 선택합니다.
