...
1. Voltamos ao workspace do Fabric, **FAIAD_<inject key="Deployment ID" enableCopy="false"/>_PT** selecionando-o no painel esquerdo.
...
3. Certifique-se de que o **Workspace** esteja definido como seu workspace do Fabric, **FAIAD_<inject key="Deployment ID" enableCopy="false"/>_PT**.
...
1. No painel esquerdo, clique em **FAIAD_<inject key="Deployment ID" enableCopy="false"/>_PT** para navegar até a página inicial do workspace.
...
11. Siga etapas semelhantes para adicionar mais três variáveis:
    ...
    a. **varIsSuccess** do tipo **String** e valor padrão **No**. Essa variável será usada para indicar se a atualização do fluxo de dados foi bem-sucedida.

    b. **varSuccess** do tipo **String** e valor padrão **Yes**. Essa variável será usada para definir o valor de varIsSuccess se a atualização do fluxo de dados for bem-sucedida.
...
8. Certifique-se de que o **Workspace** esteja definido como seu workspace **FAIAD_<inject key="Deployment ID" enableCopy="false"/>_PT**.
...
11. Selecione seu workspace do Fabric **FAIAD_<inject key="Deployment ID" enableCopy="false"/>_PT** no painel esquerdo para navegar até o workspace.
