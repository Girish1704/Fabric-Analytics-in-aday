...
2.  No menu do painel Resultados, selecione o ícone suspenso **-\> Visualizar Resultados**.
...
9.  Certifique-se de que o workspace de destino seja seu workspace do Fabric, **FAIAD\_\<nome de usuário\>**.
...
2.  A caixa de diálogo **Novo modelo semântico** é aberta. Insira **sm_FAIAD** como o nome do modelo semântico Direct Lake.


3.  Temos a opção de selecionar um subconjunto de tabelas por padrão. Lembre-se de que criamos exibições no laboratório anterior. Queremos incluir essas exibições no modelo. Expanda o esquema **dbo**. Aqui você pode ver todas as tabelas e visualizações em seu lakehouse.
...
2.  Clique em **Abrir modelo semântico.**

    ![](../media/Lab-6/image17.png)


3.  No canto superior direito, verifique se você está no modo **Edição**.
...
5.  Vamos criar um relacionamento entre as tabelas Sales e Reseller. Selecione **ResellerID** na tabela **Sales** e arraste-o para **ResellerID** na tabela **Reseller**.

    ![](../media/Lab-6/image20.png)


6.  A caixa de diálogo Novo relacionamento é aberta. Verifique se a tabela **From** é **Sales** e **Coluna** é **ResellerID**.


7.  Verifique se a tabela **To** é **Reseller** e **Coluna** é **ResellerID**.
...
17. De maneira similar, crie um relacionamento **muitos para um** entre as tabelas **Sales** e **Product**. Selecione **StockItemID** na tabela **Sales** e **StockItemID** na tabela **Product**.
...
3.  Insira **Sales = SUM(‘Sales’\[Sales Amount\])** na **barra de fórmula**.
...
29. Selecione **Fechar** para fechar a caixa de diálogo Gerenciar relacionamentos. Terminamos de criar todos os relacionamentos.
...
2.  Insira **Avg Order** = **DIVIDE(\[Sales\], \[Sales Orders\])** na barra de fórmulas.
