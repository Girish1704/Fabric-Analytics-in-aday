...
1. Vamos voltar ao **workspace do Fabric** que você criou no laboratório 2, denominado **FAIAD_<inject key="Deployment ID" enableCopy="false"/>_PT.**
...
11. Verifique se o relatório está salvo no workspace, **FAIAD_<inject key="Deployment ID" enableCopy="false"/>_PT**.
...
1. No **painel esquerdo**, selecione o nome do seu workspace, **FAIAD_<inject key="Deployment ID" enableCopy="false"/>_PT** para ser direcionado para o workspace.
...
3. Verifique se o relatório está salvo no workspace **FAIAD_<inject key="Deployment ID" enableCopy="false"/>_PT.**
...
3. Selecione **FAIAD_<inject key="Deployment ID" enableCopy="false"/>_PT** na barra de menus à esquerda a fim de navegar até a home page do workspace.
...
1. Selecione o workspace **FAIAD_<inject key="Deployment ID" enableCopy="false"/>_PT** no painel esquerdo para navegar até a home page do workspace.
