...
8.  Selecione o **ícone** **Formatar página** no painel
    **Visualizações**.
...
10. Selecione a **lista suspensa Cor**. A caixa de diálogo Paleta de
    cores é aberta.
...
17. Use o controle deslizante **Tela de fundo** para defini-lo como
    **Desativado**.
...
20. **Copie** o visual pressionando **Ctrl+V** no teclado. O visual é
    colado na tela.

21. Com o **novo visual realçado**, no **painel Visualizações -\> Criar
    visual -\> seção Campos**, remova a medida **Sales**.

22. Na seção **Dados**, expanda a tabela **Sales** e selecione a medida
    **Units**.
...
2.  No **menu superior**, selecione **Abrir modelo semântico**. Observe
...
7.  No painel **Propriedades**, à esquerda, expanda a seção
    **Avançado**.
...
10. No **painel** **Dados** da direita, expanda a tabela **Date**.
    Observe que Year não é campo de soma.
...
9.  No painel **Propriedades**, à esquerda, expanda a seção
    **Avançado**.
...
16. Na faixa de opções, selecione **Página Inicial -\> Colar**. Observe
    ...
    semântico atualmente não cria hierarquia a partir do campo de data.
...
3.  Selecione **FAIAD\_\<nome de usuário\>** na barra de menus à
...
24. No menu superior, selecione o **Ícone Atualizar**. Observe agora no
    ...
    Os Pipelines ajudam a resolver esse problema, oferecendo o recurso de
    tentar novamente a atualização em caso de falha e em intervalos
    diferentes.
