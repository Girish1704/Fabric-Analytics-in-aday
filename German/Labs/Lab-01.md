...
2. Sobald das Dialogfeld „E-Mail-Adresse eingeben" angezeigt wird,
    kopieren Sie den **Benutzernamen**, fügen Sie ihn in das Feld
...
6. Sehen wir nun die Produktinformationen nach Produktgruppe und
    Wiederverkäufer an. Klicken Sie im Balkendiagrammvisual „Sales nach
    Product Group und Reseller Company" mit der rechten Maustaste auf
...
8. Nachdem Sie die Informationen auf dieser Seite gelesen haben, wählen
    Sie oben links auf der Seite den **STRG+Zurückpfeil** aus, um zum
    Umsatzbericht zurückzukehren.
