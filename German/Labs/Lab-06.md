...
1. Wählen Sie im Menü „SQL-Analyseendpunkt" die Option **Neues
    semantisches Modell** aus.

    ![](../media/Lab-06/image12.png)

2. Das Dialogfeld „Neues semantisches Modell" wird geöffnet. Geben Sie
    **sm_FAIAD** als Name des Direct Lake-Semantikmodells ein.

3. Wir haben standardmäßig die Möglichkeit, eine Teilmenge der Tabellen
